...
import { framingFor, type FramingName } from "./layout";
 ...
 * GSAP moments: the camera's rotation is permanently identity (straight
 * front view, zero yaw, zero tilt), pointer movement is ignored entirely,
 * and the only narrative move is a barely-there dolly when the drawer
 * opens. It reacts to experience state but never drives it.
 */
export function CameraRig() {
  ...
  useLayoutEffect(() => {
    camera.rotation.set(0, 0, 0); // straight ahead, permanently
